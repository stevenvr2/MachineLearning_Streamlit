...
# ETAPA01 - DEFINIÇÃO DAS FEATURES
FEATURES_NAMES = [
    'Nota_P1',
    'Nota_P2',
    'Media_Trabalhos',
...
#ETAPA02: CONFIGURAÇÃO DA INTERFACE DO USUÁRIO(STREAMLIT)

st.set_page_config(layout='wide', page_title="Previsão de notas")

st.title("🤖 Previsor de desempenho acadêmico")
st.markdown( """ 
    Essa ferramenta usa inteligência Artificial para prever o status final (Aprovado ou Reprovado)
...
if pipeline_modelo is not None:
    ...
    with st.form("Formulario_previsao"):
        ...
        with col2:
            ...
            acesso_mes = st.number_input("Media de acessos a plataforma (por mês)", min_value=0, max_value=100, value=10)
    ...
    st.warning("O aplicativo não pode fazer previsões porque o modelo não carregado!")